function pluralify(num: number): string {
  return num === 1 ? "" : "s";
}

const positiveMessages: Record<string, (arg?: any) => string> = {
...
const negativeMessages: Record<string, (arg?: any) => string> = {
...
export default function validationMessages(method: string, arg: any, inverted?: boolean): string | undefined {
